...
describe User do
  ...
  # run code inside before block before each example
  before { @user = User.new(name: "Example User", email: "user@example.com",
							password: "foobar", password_confirmation: "foobar") }
  #before do
	#@user = User.new(name: "Example User", email: "user@example.com")
  #end
  # make @user default subject of test example
  subject { @user }
  # test for existence of User attributes
  ...
  describe "when email address is already taken" do
	before do
		user_with_same_email = @user.dup # duplicate user
		user_with_same_email.email.upcase! # = @user.email.upcase
  ...
  describe "following" do
    ...
    # test for reverse relationships
